...
| **Agriculture** | `agriculture_smoke.sh` → `solution_blueprints_smoke.sh` | Scaffold (`field_patrol.sd`) |
| **Environmental** | `solution_blueprints_smoke.sh` | Scaffold (`sensor_mesh.sd`) |
| **Maritime** | `solution_blueprints_smoke.sh` | Scaffold (`harbor_patrol.sd`) |

...
fn keywords() -> HashMap<&'static str, TokenType> {
    ...
    HashMap::from([
        ...
        ("requires_connectivity", TokenType::RequiresConnectivity),
        ("connectivity", TokenType::Connectivity),
        ("geofence", TokenType::Geofence),
        ("connectivity_policy", TokenType::ConnectivityPolicy),
        ("bluetooth", TokenType::Bluetooth),
        ("ble_service", TokenType::BleService),
        ("packet_loss", TokenType::PacketLoss),
        ("switch_if", TokenType::SwitchIf),
        ("trusted_only", TokenType::TrustedOnly),

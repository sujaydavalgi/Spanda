...
pub fn official_package_for_module(module_path: &str) -> Option<&'static str> {
    ...
    match module_path {
        ...
        "iot.thread" => Some("spanda-thread"),
        "iot.zwave" => Some("spanda-zwave"),
        "iot.bacnet" => Some("spanda-bacnet"),
        "iot.knx" => Some("spanda-knx"),
        "bridge.home_assistant" => Some("spanda-home-assistant"),
        "energy.solar" => Some("spanda-energy"),
        "building.entity" => Some("spanda-building"),
        "access.lock" => Some("spanda-smart-locks"),
        "environment.aq" => Some("spanda-environment"),

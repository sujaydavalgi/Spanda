...
pub use recovery::{
    ...
    plan_fleet_recovery, program_has_recovery_for_issue, record_recovery_outcome,
    recovery_from_diagnosis, save_recovery_knowledge_store, simulate_failure_recovery,

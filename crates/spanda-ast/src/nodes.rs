//! Spanda language abstract syntax tree types extracted for the Phase 4 compiler split.
//!
...
pub enum Program {
    Program {
        ...
        #[serde(default)]
        fleets: Vec<crate::robotics_decl::FleetDecl>,
        #[serde(default)]
        swarms: Vec<crate::robotics_decl::SwarmDecl>,
        #[serde(default)]
        program_safety_zones: Vec<crate::robotics_decl::ProgramSafetyZoneDecl>,
        #[serde(default)]
        certifications: Vec<crate::robotics_decl::CertifyDecl>,
        #[serde(default)]
...
pub enum RobotDecl {
    RobotDecl {
        ...
        buses: Vec<crate::comm_decl::BusDecl>,
        peer_robots: Vec<crate::comm_decl::PeerRobotDecl>,
...
pub enum TopicDecl {
    TopicDecl {
        ...
        topic: Option<String>,
        #[serde(default)]
        role: crate::comm_decl::TopicRole,
        #[serde(default)]
        qos: Option<crate::comm_decl::QosDecl>,
        #[serde(default)]
        transport: Option<crate::comm_decl::TransportKind>,
        #[serde(default)]
...
pub enum Stmt {
    ...
    DiscoverStmt {
        target: crate::comm_decl::DiscoverTarget,
        filter: Option<crate::comm_decl::DiscoverFilter>,
        span: Span,
    },
    ReceiveStmt {
        topic_name: String,
...
pub enum LiteralValue {
    ...
    Bool(bool),
    Null,
    Regex(crate::regex::RegexPattern),
}

...
| **Hardware & verify** | [`spanda-hardware`](spanda-hardware/README.md), [`spanda-certify`](spanda-certify/README.md), `spanda-capability`, [`spanda-readiness`](spanda-readiness/) | Profile catalog; certification proofs; capability/traceability/health analysis; **operational readiness**. Public `verify_compatibility` API: `spanda-core::hardware_verify` |
...
| **Connectivity** | [`spanda-connectivity`](spanda-connectivity/README.md), [`spanda-connectivity-runtime`](spanda-connectivity-runtime/README.md) | Connectivity catalogs; `HardwareProfile` foundation types; runtime validation |
| **Hardware profiles** | [`spanda-hardware`](spanda-hardware/README.md) | Builtin profile catalog (re-exports connectivity types) |
...
- [docs/architecture-waiver-burn-down.md](../docs/architecture-waiver-burn-down.md) — completed burn-down (0 production upward waivers)

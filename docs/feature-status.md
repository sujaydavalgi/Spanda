...
| **Human Interaction & Spatial Computing (H1–H4)** | H1–H4 **experimental**; stable hardening checklist + `hri_stable_promotion_gate.sh` + `@spanda/web` Humans tab parity **shipped** — promotion to **Stable** pending field soak + audit — [stable-hardening-human-interaction.md](./stable-hardening-human-interaction.md) |

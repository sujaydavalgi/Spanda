...
|-------|------------|----------------|
| **Public facade** | `spanda-core` | Stable re-exports, `hardware_verify`, thin shims for embedders |
...
| **Domain** | `spanda-connectivity`, `spanda-hardware`, `spanda-fleet`, `spanda-ota`, `spanda-certify`, `spanda-assurance`, `spanda-readiness` | Hardware profiles, verify facade, fleet, deploy, assurance analysis |

...
- **Interpreter Phase 8 (partial):** runtime tree routes AST, foundations, comm/robotics decls, and robotics runtime state through `spanda-ast` / `spanda-runtime` instead of `crate::ast` / `crate::foundations`; `lean_core_shims` guard added.
